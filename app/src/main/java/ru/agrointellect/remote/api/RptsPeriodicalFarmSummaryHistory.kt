...
import ru.agrointellect.remote.bean.RptPeriodicalDataTable

class RptsPeriodicalFarmSummaryHistory : RptsBaseFarmSummaryHistory<RptPeriodicalDataTable>() {

    @SerializedName("data_table")
    @Expose
    override lateinit var data: RptPeriodicalDataTable

    @Suppress("UNCHECKED_CAST")
    @SuppressLint("DefaultLocale")
    override fun rowsBy(name: String): List<Row> {
        val method = RptPeriodicalDataTable::class.java.getMethod("get${name.capitalize()}")
        val list = method.invoke(data) as List<String>
        return data.date.mapIndexed { i, date -> newRow(date, list.getOrNull(i)) }
    }
}

abstract class RptsBaseFarmSummaryHistory<T : RptPeriodicalDataTable> : Table {
