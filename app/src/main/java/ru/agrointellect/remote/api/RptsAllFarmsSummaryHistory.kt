...
abstract class ListFarmSummaryHistory<T : PeriodicalDataTable> : Table {
    ...
    override val columns: List<Column>
        get() = listOf(
            ...
            Column(D["evt_preg_check_cows"], rowsBy("evtPregCheckCows")),
            Column(D["evt_got_preg_cows"], rowsBy("evtGotPregCows")),
            Column(D["evt_preg_check_heifers"], rowsBy("evtPregCheckHeifers")),
            ...
            Column(D["mlk_avg_milk_sum_yield"], rowsBy("mlkAvgMilkSumYield")),
            Column(D["mlk_sum_milk_sum_yield"], rowsBy("mlkSumMilkSumYield")),
            Column(D["mlk_avg_milk_per_cow"], rowsBy("mlkAvgMilkPerCow")),
            Column(D["mlk_sum_milk_per_cow"], rowsBy("mlkSumMilkPerCow")),
            Column(D["mlk_avg_milk_per_lact_cow"], rowsBy("mlkAvgMilkPerLactCow")),
            Column(D["mlk_sum_milk_per_lact_cow"], rowsBy("mlkSumMilkPerLactCow")),
